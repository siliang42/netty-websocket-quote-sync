...
import com.jiayi.utils.GZipUtils;
...
/**
 * @Description: 币安网WebSocket 消息处理类
 * 自定义入站的handler 这个也是核心类
 *
 * @author jiayi
 * @date 2021年07月03日16:43:52
 */
@Slf4j
public class BinanceWebSocketClientHandler extends SimpleChannelInboundHandler<Object> {
    ...
    public BinanceWebSocketClientHandler(WebSocketClientHandshaker handshaker, BinanceWebSocketClient client) {
